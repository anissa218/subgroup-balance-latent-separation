...
class MIMICLitModule(LightningModule):
    ...
    def on_load_checkpoint(self, checkpoint: Dict[str, Any]) -> None:
        """Hook called after loading a checkpoint. Resets classifier head only during training."""
        # only reset if we're in training mode (fit)
...
if __name__ == "__main__":
    _ = MIMICLitModule(None, None, None, None)
